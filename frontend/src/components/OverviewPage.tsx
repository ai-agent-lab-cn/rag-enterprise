...
const ACTIONS = [
  ...
  { label: "回答评测", note: "评估回答质量", path: "/evaluation?view=reports", icon: <BarChart3 size={22}/> },
  { label: "检索评测", note: "评估检索效果", path: "/evaluation?view=reports", icon: <SearchCheck size={22}/> },
