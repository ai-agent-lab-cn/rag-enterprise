...
export const api = {
  ...
  getIndexVersionCreationContext: (id: string) => request<IndexVersionCreationContext>(`/api/knowledge-bases/${id}/index-version-creation-context`),
  previewIndexVersion: (
    id: string,
  ...
  listIndexVersionValidations: (id: string, versionId: string) => request<ValidationReport[]>(`/api/knowledge-bases/${id}/index-versions/${versionId}/validations`),
  ...
  retireIndexVersion: (id: string, versionId: string) => request<Record<string, string>>(`/api/knowledge-bases/${id}/index-versions/${versionId}/retire`, { method: "POST" }),
